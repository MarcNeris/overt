...
class regmun000sSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
         DB::unprepared("INSERT INTO regmun000s (CodMun, NomMun, CodUfe) VALUES
...
(202406, 'Capitão de Campos', 'PI'),
(202455, 'Capitão Gervásio Oliveira', 'PI'),
(202505, 'Caracol', 'PI'),
(202539, 'Caraúbas do Piauí', 'PI'),
(202554, 'Caridade do Piauí', 'PI'),
(202604, 'Castelo do Piauí', 'PI'),
(202653, 'Caxingó', 'PI'),
(202703, 'Cocal', 'PI'),
(202711, 'Cocal de Telha', 'PI'),
(202729, 'Cocal dos Alves', 'PI'),
(202737, 'Coivaras', 'PI'),
(202752, 'Colônia do Gurguéia', 'PI'),
(202778, 'Colônia do Piauí', 'PI'),
(202802, 'Conceição do Canindé', 'PI'),
(202851, 'Coronel José Dias', 'PI'),
(202901, 'Corrente', 'PI'),
(203008, 'Cristalândia do Piauí', 'PI'),
(203107, 'Cristino Castro', 'PI'),
(203206, 'Curimatá', 'PI'),
(203230, 'Currais', 'PI'),
(203255, 'Curralinhos', 'PI'),
(203271, 'Curral Novo do Piauí', 'PI'),
(203305, 'Demerval Lobão', 'PI'),
(203354, 'Dirceu Arcoverde', 'PI'),
(203404, 'Dom Expedito Lopes', 'PI'),
(203420, 'Domingos Mourão', 'PI'),
(203453, 'Dom Inocêncio', 'PI'),
(203503, 'Elesbão Veloso', 'PI'),
(203602, 'Eliseu Martins', 'PI'),
(203701, 'Esperantina', 'PI'),
(203750, 'Fartura do Piauí', 'PI'),
(203800, 'Flores do Piauí', 'PI'),
(203859, 'Floresta do Piauí', 'PI'),
(203909, 'Floriano', 'PI'),
(204006, 'Francinópolis', 'PI'),
(204105, 'Francisco Ayres', 'PI'),
(204154, 'Francisco Macedo', 'PI'),
(204204, 'Francisco Santos', 'PI'),
(204303, 'Fronteiras', 'PI'),
(204352, 'Geminiano', 'PI'),
(204402, 'Gilbués', 'PI'),
(204501, 'Guadalupe', 'PI'),
(204550, 'Guaribas', 'PI'),
(204600, 'Hugo Napoleão', 'PI'),
(204659, 'Ilha Grande', 'PI'),
(204709, 'Inhuma', 'PI'),
(204808, 'Ipiranga do Piauí', 'PI'),
(204907, 'Isaías Coelho', 'PI'),
(205003, 'Itainópolis', 'PI'),
(205102, 'Itaueira', 'PI'),
(205151, 'Jacobina do Piauí', 'PI'),
(205201, 'Jaicós', 'PI'),
(205250, 'Jardim do Mulato', 'PI'),
(205276, 'Jatobá do Piauí', 'PI'),
(205300, 'Jerumenha', 'PI'),
(205359, 'João Costa', 'PI'),
(205409, 'Joaquim Pires', 'PI'),
(205458, 'Joca Marques', 'PI'),
(205508, 'José de Freitas', 'PI'),
(205516, 'Juazeiro do Piauí', 'PI'),
(205524, 'Júlio Borges', 'PI'),
(205532, 'Jurema', 'PI'),
(205540, 'Lagoinha do Piauí', 'PI'),
(205557, 'Lagoa Alegre', 'PI'),
...
(2308005, 'Massapê', 'CE');
INSERT INTO regmun000s (CodMun, NomMun, CodUfe) VALUES
(2308104, 'Mauriti', 'CE'),
(2308203, 'Meruoca', 'CE'),
(2308302, 'Milagres', 'CE'),
(2308351, 'Milhã', 'CE'),
...
(5300108, 'Brasília', 'DF');");
	...
	DB::unprepared("update regmun000s set created_at = '". date('Y-m-d H:i:s')."'");
	DB::unprepared("update regmun000s set updated_at = '". date('Y-m-d H:i:s')."'");
