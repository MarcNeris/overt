...
class regcne000sSeeder extends Seeder
{
    /**
    ...
    {
        DB::unprepared("
INSERT INTO regcne000s (CodCne, DscCne) VALUES
...
");	
	DB::unprepared("update regcne000s set created_at = '". date('Y-m-d H:i:s')."'");
	DB::unprepared("update regcne000s set updated_at = '". date('Y-m-d H:i:s')."'");
    }
}
