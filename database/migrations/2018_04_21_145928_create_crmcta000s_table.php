...
class CreateCrmcta000sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crmcta000s', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->char        ('SitCta', 1)   ->comment('Situação da Conta');
            $table->float       ('CapEmp',15, 2)->comment('Capital Social da Conta')->nullable();
    ...
    {
        Schema::dropIfExists('crmcta000s');
    }
}
