...
! function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf(' %s to %s de %s Registros', pageFrom, pageTo, totalRows);
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        html.push('</div>',
            ...
            '<li class="page-first"><a class"btn" href="javascript:void(0)">' + this.options.paginationFirstText + ' Primeiro</a></li>',
            '<li class="page-pre"><a href="javascript:void(0)">' + this.options.paginationPreText + 'Voltar</a></li>');
        ...
        for (i = from; i <= to; i++) {
            html.push('<li class="btn page-number page-item' + (i === this.options.pageNumber ? ' active' : '') + '">',
                '<a href="javascript:void(0)">', i, '</a>',
                '</li>');
        }

        html.push(
            '<li class="page-next"><a class"page-link" href="javascript:void(0)">' + this.options.paginationNextText + ' Próximo</a></li>',
            '<li class="page-last"><a href="javascript:void(0)">' + this.options.paginationLastText + ' Último</a></li>',
            '</ul>',
            '</div>');
